# ARCHIVIO — DA-FARE come era fino al 2026-08-01

> **Questo file è un archivio: non si aggiorna e non si lavora da qui.** È il documento `DA-FARE.md`
> nella forma che aveva fino al 2026-08-01, quando è stato snellito a indice di soli punti aperti.
>
> Serve a una cosa sola: conservare il **perché** dei punti già chiusi — le motivazioni, le misure e
> le alternative scartate, che spesso valgono più della conclusione. Se cerchi cosa resta da fare,
> guarda `docs/DA-FARE.md`; se cerchi il racconto di una sessione, `docs/DIARIO.md`.
>
> Il testo che segue è quello originale, invariato.
